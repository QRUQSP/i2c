...
//
ciniki_core_loadMethod($ciniki, 'qruqsp', 'i2c', 'private', 'devicesPoll');
$rc = qruqsp_i2c_devicesPoll($ciniki, $tnid);
if( $rc['stat'] != 'ok' ) {
    ciniki_cron_logMsg($ciniki, $tnid, array('code'=>'qruqsp.i2c.15', 'severity'=>50, 'msg'=>'Unable to poll devices', 'err'=>$rc['err']));
}
